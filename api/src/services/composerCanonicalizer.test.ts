...
describe('composerCanonicalizer', () => {
  ...
  describe('formatComposerName', () => {
    ...
    it('should handle particles correctly', () => {
      ...
      expect(formatComposerName('claude de france')).toBe('Claude de France')
    })

    it('should handle hyphenated names', () => {
      expect(formatComposerName('villa-lobos')).toBe('Villa-Lobos')
      expect(formatComposerName('mendelssohn-bartholdy')).toBe(
    ...
    it('should handle initials', () => {
      ...
      expect(formatComposerName('c.p.e. bach')).toBe('C.P.E. Bach')
    })
