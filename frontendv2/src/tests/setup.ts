...
// Mock ResizeObserver (use function keyword for Vitest 4.0 constructor mocks)
...
// Mock DOMMatrix for PDF.js (use function keyword for Vitest 4.0 constructor mocks)
global.DOMMatrix = vi.fn().mockImplementation(function () {
  return {
    a: 1,
    b: 0,
    c: 0,
...
// Mock OffscreenCanvas for PDF rendering (use function keyword for Vitest 4.0 constructor mocks)
