/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b1ff15ff4aa3ef86c1c414ad01d2218)
// Runtime types generated with workerd@1.20250712.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    ...
    SYNC_COORDINATOR: DurableObjectNamespace<
      import('./src/index').SyncCoordinator
    >
    DB: D1Database
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'ENVIRONMENT' | 'API_URL' | 'FRONTEND_URL' | 'JWT_SECRET'
      >
    > {}
}
