...
if (existsSync(lockFile)) {
  const lockTime = parseInt(readFileSync(lockFile, 'utf8'))
  const now = Date.now()
  ...
  if (now - lockTime > 30000) {
    ...
    console.log('Build already in progress, exiting...')
    process.exit(0)
  }
}
