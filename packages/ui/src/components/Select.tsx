      ...
      <Listbox value={value} onChange={onChange} disabled={disabled}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute z-50 mt-1 max-h-[45dvh] sm:max-h-60 w-full overflow-auto touch-scroll overscroll-contain rounded-md bg-white dark:bg-gray-800 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
              {options.map(option => (
                <Listbox.Option
                  key={option.value}
