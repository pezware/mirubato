...
🎸 Multi-instrument support (guitar & piano) • 🎵 Real-time audio playback • 📱 Mobile-first design • 🎯 Practice logging & analytics • 📚 Repertoire & goals tracking • 🎼 Sheet music library • 📅 Practice planning & templates • 🔄 Real-time sync • 🌐 Open source (MIT)
...
| **🚧 Status**     | v1.8.0 Public Preview - Practice Planning, User Profiles & Enhanced Sync |
